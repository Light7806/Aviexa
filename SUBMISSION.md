# Aviexa.exe — Hackathon Submission
...
- [x] Web UI golden demo path
- [x] FastAPI backend with all required routes
- [x] `/demo/golden` one-shot endpoint
- [x] Bob mock diagnosis (no key needed)
- [x] PDF report generation
- [x] VS Code integration check + open
- [x] `verify_demo.py` passes
- [ ] Public GitHub repo
- [ ] Video presentation
- [ ] Cover image
